...
* <https://github.com/kr1sp1n/awesome-gemini> ⭐ 1,550 | 🐛 12 | 📅 2026-06-07
...
* [gembro](https://git.sr.ht/~rafael/gembro) (Go) - gemini client using [Bubble Tea](https://github.com/charmbracelet/bubbletea) ⭐ 45,029 | 🐛 227 | 🌐 Go | 📅 2026-09-17.
...
* [Kristall](https://github.com/MasterQ32/kristall) ⭐ 797 | 🐛 43 | 🌐 C++ | 📅 2026-09-08 (C++) - graphical Gopher and Gemini client using QT.
...
* [eGemi](https://github.com/nfnitloop/egemi) ⭐ 6 | 🐛 4 | 🌐 Rust | 📅 2025-08-17 (Rust) - Read gemtext and other plaintexts via `gemini://` *and* `https://`. (uses [egui](https://github.com/emilk/egui) ⭐ 30,624 | 🐛 1,131 | 🌐 Rust | 📅 2026-09-18)
...
* [dremini](https://github.com/marty1885/dremini) ⭐ 11 | 🐛 0 | 🌐 C++ | 📅 2026-09-18 (C++) - Highly concurrent C++ Gemini server and client library
...
* [gemini.yml](https://github.com/zyedidia/micro/blob/master/runtime/syntax/gemini.yaml) ⭐ 29,606 | 🐛 935 | 🌐 Go | 📅 2026-09-19 - text/gemini syntax highlighting for micro.
