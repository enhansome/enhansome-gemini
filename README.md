...
* [gembro](https://git.sr.ht/~rafael/gembro) (Go) - gemini client using [Bubble Tea](https://github.com/charmbracelet/bubbletea) ⭐ 44,490 | 🐛 200 | 🌐 Go | 📅 2026-08-19.
...
* [Kristall](https://github.com/MasterQ32/kristall) ⭐ 795 | 🐛 43 | 🌐 C++ | 📅 2026-04-26 (C++) - graphical Gopher and Gemini client using QT.
* [Geopard](https://github.com/ranfdev/Geopard) ⭐ 206 | 🐛 41 | 🌐 Rust | 📅 2025-09-01 (Rust) - A colorful, adaptive gemini browser.
* [Alhena](https://github.com/mochaman/alhena) ⭐ 59 | 🐛 1 | 🌐 Java | 📅 2026-08-22 - (Java) themes, color emojis on Mac, inline images, etc. jlinked exes do not require Java.
...
* [eGemi](https://github.com/nfnitloop/egemi) ⭐ 6 | 🐛 4 | 🌐 Rust | 📅 2025-08-17 (Rust) - Read gemtext and other plaintexts via `gemini://` *and* `https://`. (uses [egui](https://github.com/emilk/egui) ⭐ 30,127 | 🐛 1,138 | 🌐 Rust | 📅 2026-08-22)
...
* [Agate](https://github.com/mbrubeck/agate) ⭐ 747 | 🐛 7 | 🌐 Rust | 📅 2026-08-20 (Rust) - simple Gemini server for static files.
...
* [gemini.yml](https://github.com/zyedidia/micro/blob/master/runtime/syntax/gemini.yaml) ⭐ 29,414 | 🐛 1,033 | 🌐 Go | 📅 2026-08-22 - text/gemini syntax highlighting for micro.
