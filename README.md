...
* [gembro](https://git.sr.ht/~rafael/gembro) (Go) - gemini client using [Bubble Tea](https://github.com/charmbracelet/bubbletea) ⭐ 44,565 | 🐛 202 | 🌐 Go | 📅 2026-08-19.
...
* [eGemi](https://github.com/nfnitloop/egemi) ⭐ 6 | 🐛 4 | 🌐 Rust | 📅 2025-08-17 (Rust) - Read gemtext and other plaintexts via `gemini://` *and* `https://`. (uses [egui](https://github.com/emilk/egui) ⭐ 30,172 | 🐛 1,132 | 🌐 Rust | 📅 2026-08-26)
...
* [Agate](https://github.com/mbrubeck/agate) ⭐ 747 | 🐛 8 | 🌐 Rust | 📅 2026-08-26 (Rust) - simple Gemini server for static files.
...
* [gemini.yml](https://github.com/zyedidia/micro/blob/master/runtime/syntax/gemini.yaml) ⭐ 29,438 | 🐛 1,015 | 🌐 Go | 📅 2026-08-26 - text/gemini syntax highlighting for micro.
