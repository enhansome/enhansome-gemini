...
* <https://github.com/kr1sp1n/awesome-gemini> ⭐ 1,533 | 🐛 8 | 📅 2026-06-07
...
* [gembro](https://git.sr.ht/~rafael/gembro) (Go) - gemini client using [Bubble Tea](https://github.com/charmbracelet/bubbletea) ⭐ 44,345 | 🐛 200 | 🌐 Go | 📅 2026-08-12.
* [Amfora](https://github.com/makeworld-the-better-one/amfora) ⭐ 1,349 | 🐛 10 | 🌐 Go | 📅 2026-07-03 (Go) - "fancy" terminal client. In [maintenance mode](https://www.makeworld.space/2023/08/bye_gemini.html).
...
* [gplaces](https://github.com/dimkr/gplaces) ⭐ 48 | 🐛 1 | 🌐 C | 📅 2026-06-18 (C) - command-driven, terminal based Gemini client in \~1K LOC of C.
...
* [Agregore](https://github.com/RangerMauve/agregore-browser#fetch-api-for-gemini) ⭐ 920 | 🐛 103 | 🌐 JavaScript | 📅 2026-07-13 - (Electron.js) - peer to peer web browser with support for loading Gemini pages.
* [Kristall](https://github.com/MasterQ32/kristall) ⭐ 793 | 🐛 42 | 🌐 C++ | 📅 2026-04-26 (C++) - graphical Gopher and Gemini client using QT.
* [Geopard](https://github.com/ranfdev/Geopard) ⭐ 206 | 🐛 41 | 🌐 Rust | 📅 2025-09-01 (Rust) - A colorful, adaptive gemini browser.
* [Alhena](https://github.com/mochaman/alhena) ⭐ 59 | 🐛 1 | 🌐 Java | 📅 2026-08-10 - (Java) themes, color emojis on Mac, inline images, etc. jlinked exes do not require Java.
...
* [eGemi](https://github.com/nfnitloop/egemi) ⭐ 6 | 🐛 4 | 🌐 Rust | 📅 2025-08-17 (Rust) - Read gemtext and other plaintexts via `gemini://` *and* `https://`. (uses [egui](https://github.com/emilk/egui) ⭐ 30,043 | 🐛 1,123 | 🌐 Rust | 📅 2026-08-12)
...
* [Jimmy](https://github.com/jfoucher/Jimmy) ⭐ 80 | 🐛 8 | 🌐 Swift | 📅 2023-09-10 (SwiftUI) - a lightweight native Gemini client for MacOS
...
* [ignition](https://github.com/cbrews/ignition) ⚠️ Archived (Python) - Gemini client transport/request library for python3.
...
* [dremini](https://github.com/marty1885/dremini) ⭐ 11 | 🐛 0 | 🌐 C++ | 📅 2026-07-27 (C++) - Highly concurrent C++ Gemini server and client library
...
* [gmir](https://github.com/codesoap/gmir) ⭐ 8 | 🐛 0 | 🌐 Go | 📅 2024-11-09 (Go) - A reader for gmi files
...
* [Agate](https://github.com/mbrubeck/agate) ⭐ 744 | 🐛 7 | 🌐 Rust | 📅 2026-08-10 (Rust) - simple Gemini server for static files.
* [Jetforce](https://github.com/michael-lazar/jetforce) ⭐ 217 | 🐛 5 | 🌐 Python | 📅 2026-02-09 (Python) - built-in static file server with support for gemini directories and CGI scripts.
...
* [Mehari](https://github.com/Psi-Prod/Mehari) ⭐ 40 | 🐛 0 | 🌐 OCaml | 📅 2026-08-04 - Featureful server in OCaml
...
* [Yo!](https://github.com/YGGverse/Yo/tree/gemini) ⭐ 3 | 🐛 7 | 🌐 PHP | 📅 2024-04-18 (PHP) - Search server and crawler with history snap support, based on [Manticore](https://github.com/manticoresoftware)
...
* [pulsarss](https://github.com/YGGverse/pulsarss) ⭐ 2 | 🐛 0 | 🌐 Rust | 📅 2025-09-03 (Rust) - Crawl & Convert RSS feeds into static Gemtext
...
* [dioscuri](https://github.com/wooorm/dioscuri) ⭐ 44 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-09 (JS) - A Gemtext parser with interfaces to transform to and from mdast (markdown ast) and to compile to HTML.
...
* [gemini.yml](https://github.com/zyedidia/micro/blob/master/runtime/syntax/gemini.yaml) ⭐ 29,328 | 🐛 1,031 | 🌐 Go | 📅 2026-08-13 - text/gemini syntax highlighting for micro.
* [language\_gmi](https://github.com/lite-xl/lite-xl-plugins/blob/master/plugins/language_gmi.lua) ⭐ 512 | 🐛 124 | 🌐 Lua | 📅 2026-05-06 - gemtext syntax highlighting for lite-xl
